...
public class RotationEnemy extends Enemy {
	
	//In degrees
	float angle;
	float distance;
	
	public RotationEnemy(float x1, float y1) {
	...
	public RotationEnemy(float x1, float y1, float dist) {
		this(x1, y1);
		distance = dist;
	}
	
	public RotationEnemy(Vector2 pos) {
		this(pos.x, pos.y);
	}
	
	public RotationEnemy(Vector2 pos, float dist) {
		this(pos.x, pos.y);
		distance = dist;
	}
